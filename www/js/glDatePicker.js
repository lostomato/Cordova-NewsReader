 ...
 ;(function() {
	...
	$.fn.glDatePicker.defaults =
	{
		...
		onClick: (function(el, cell, date, data) {
			el.val(date.toLocaleDateString('zh-CN'));
            cnDateForm = (date.getFullYear() + '/' +
            (date.getMonth()+1) + '/' +
            date.getDate());
            dateInputChange(cnDateForm);
					...
					for(var col = 0; col < maxCol; col++, cellIndex++) {
						...
						if(!row) {
							...
							if(!isSelectable ||
								...
								cellClass = ([ '周日', '周一', '周二', '周三', '周四', '周五', '周六' ])[cellDateVal.day];
